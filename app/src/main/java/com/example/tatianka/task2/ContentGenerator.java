    ...
    private void generate(int pageNumber){
        ...
        switch (pageNumber) {
            case 0:
                ...
                mContent.add(new Content("CE-123456", 0, 3, "10 лютого 2016", "10 лютого 2016", "10 лютого 2016", "Відкритий люк (біля рекламного щита), район повороту 18 та 19 трамваїв на проспект Миру з Донецького шоссе", "пр. Мира", "Днепропетровский МВК()", state, new ContentType(ContentType.Type.MUNICIPAL))); //[Comment] hardcode
                break;
